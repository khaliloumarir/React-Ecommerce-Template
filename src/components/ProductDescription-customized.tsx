...
import downloadIcon from "../assets/icons/envelope-paper.svg";
...
export default function ProductDescription({
  ...
  const importantArgument: {
  ...
  }[] = [
    {
      ...
      title: "Purchase",
      description:
        "Once the payment is confirmed, we will send you an email within 24 Hours",
    },
    {
      icon: downloadIcon,
      title: "Check your emails",
      description: "Check Your emails after 24 hours for the pdf",
    },
    {
      icon: crochetingIcon,
      title: "Start Crocheting",
      description:
        "Open the pdf & start crocheting beautiful Merbabies Amigurumi with our in depth step-by-step guide",
    },
  ];
