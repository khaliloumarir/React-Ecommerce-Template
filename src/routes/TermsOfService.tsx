    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <section>
          <h2>OVERVIEW</h2>
          <p>
            This website is operated by {mainData.companyName}. Throughout the
            site, the terms “we”, “us” and “our” refer to {mainData.companyName}
            . {mainData.companyName} offers this website, including all
            ...
            any changes constitutes acceptance of those changes. Our store is
            hosted on Firebase They provide us with the online e-commerce
        ...
        <section>
          ...
          <p>
            ...
            only according to our Refund Policy: Refund Policy We have made
        ...
        <section>
          ...
          <p>
            ...
            <Link to="/return-refund" className="underline text-blue-500">
              Refund Policy
            </Link>
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Marion Wares, our directors, officers, employees, affiliates,
        ...
        <section>
          ...
          <p>
            ...
            {mainData.companyName} and our parent, subsidiaries, affiliates,
        ...
        <section>
          ...
          <p>
            ...
            accordance with the laws of USA.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            {mainData.email}. Our contact information is posted below:{" "}
            {mainData.companyName} {mainData.email} {mainData.address}{" "}
            {mainData.phone}
          </p>
        </section>
      </div>
